    ...
    return (
        <div className={styles.todo__task}>
            <div className={styles.todo__taskTitleWrapper}>
                <input id={props.id} className={styles.todo__taskCheck} type="checkbox" defaultChecked={props.completed}></input>
                <label className={styles.todo__taskText} htmlFor={props.id}>
                    {props.task}
                </label>
            </div>
            <div className={styles.todo__taskBtnsWrapper}>
                <button className={styles.todo__taskDeleteBtn}>del</button>
